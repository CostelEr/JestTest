/**
 Array 137. 
     ...
     Find the maximal perimeter of a triangle with vertices 
     belonging to A. Output this perimeter and the corresponding vertices 
...
export function F(N: number, A: Point[]) {
  ...
  permax = parseFloat(permax.toFixed(2));
  console.log(permax, A[ii], A[jj], A[kk]);

  return [permax, A[ii], A[jj], A[kk]];
}
